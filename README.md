<h2>Многофункциональный телеграм-бот</h2>
...
- Изменение набора символов для ASCII арта из изображений
- Инверсия цветов изображения
- Отражение изображения
- Преобразование изображения в тепловую карту
- При получении команды <b><i>Random Joke</i></b> бот выбирает случайную шутку из списка JOKES и отправляет ее пользователю.
- При получении команды <b><i>Random Compliment</i></b> бот выбирает случайный комплимент из списка COMPLIMENTS и отправляет его пользователю.
- При получении команды <b><i>Flip a Coin</i></b> бот случайным образом выбирает результат из двух возможных "Heads"(Орел) или "Tails"(Решка) и сообщает его пользователю.
