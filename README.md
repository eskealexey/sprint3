...
- При получении команды <b><i>Flip a Coin</i></b> бот случайным образом выбирает результат из двух возможных "Heads"(Орел), "Tails"(Решка) и сообщает его пользователю.
